...
class ApplicationUI {
    ...
    userMenu(username, role) {
		...
		do {
			if (role === 'admin') {
				alert("Usted es un administrador. Tiene acceso completo.");
				option = prompt("Seleccione una opción:\n1. Cambiar contraseña\n2. Ver artículos\n3. Agregar artículo\n4. Editar artículo\n5. Eliminar artículo\n6. Comprar artículos\\n7. Descargar registro de operaciones\nX. Salir");
			} else if (role === 'client') {
				alert("Usted es un cliente. Puede ver y comprar artículos.");
				option = prompt("Seleccione una opción:\n1. Cambiar contraseña\n2. Ver artículos\n3. Comprar artículos\nX. Salir");
			}
			switch (option) {
				case '1':
